...
if (isset($_GET['timeout']) && isset($_GET['id'])) {
    $patient_id = $_GET['id'];
    $time_out = time();
    $sql = "UPDATE patients SET time_out = '$time_out' WHERE id = '$patient_id'";
...
<body>
    <div class="dashboard">
        ...
        <div class="sidebar">
            ...
            <a href="queue.php" class="sidebar-icon active" data-tooltip="Patient Queue">
                            ...
                            <div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; background: #f9f9f9;">
                                <div style="display: flex; justify-content: between; align-items: center;">
                                    <div style="flex: 1;">
                                        ...
                                        <p style="margin: 5px 0;"><strong>Time In:</strong> <?php echo date('h:i A', $patient['time_in']); ?></p>
                                        <p style="margin: 5px 0;"><strong>Doctor:</strong> <?php echo htmlspecialchars($patient['doctor_assigned']); ?></p>
                                    </div>
                                    <div style="margin-left: 20px;">
                                        <a href="?timeout=1&id=<?php echo $patient['id']; ?>" 
                                           style="background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;"
                                           onclick="return confirm('Mark patient as checked out?')">
                                            Check Out
                                        </a>
                                    </div>
                                </div>
