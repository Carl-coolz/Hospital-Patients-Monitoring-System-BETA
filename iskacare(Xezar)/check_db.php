...
if (mysqli_num_rows($patients) > 0) {
    echo "<table border='1' style='border-collapse: collapse;'>";
    echo "<tr><th>ID</th><th>Name</th><th>Age</th><th>Gender</th><th>student_id</th><th>student_course</th><th>student_year</th><th>Condition</th><th>Time In</th><th>Time Out</th></tr>";
    while ($patient = mysqli_fetch_assoc($patients)) {
        ...
        echo "<td>" . $patient['student_id'] . "</td>";
        echo "<td>" . $patient['student_course'] . "</td>";
        echo "<td>" . $patient['student_year'] . "</td>";
