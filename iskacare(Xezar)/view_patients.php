    ...
    if ($patient_id >= 0 && !empty($patient_name)) {
        ...
        if ($get_patient && mysqli_num_rows($get_patient) > 0) {
            ...
            try {
                ...
                $delete_monitoring = mysqli_query($conn, "DELETE FROM monitoring WHERE patient_id = $patient_id");
                if (!$delete_monitoring) {
                    throw new Exception("Error deleting monitoring records: " . mysqli_error($conn));
                }
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            <thead>
                                <tr style="background: #f8f9fa;">
                                    ...
                                    <th style="padding: 15px; text-align: left; border-bottom: 2px solid #ddd;">Year Level</th>
                            ...
                            <tbody>
                                <?php while($patient = mysqli_fetch_assoc($patients)): ?>
                                    <tr style="border-bottom: 1px solid #eee;">
                                        ...
                                        <td style="padding: 15px;">
                                            <?php echo $patient['student_course']; ?>
                                        </td>
                                        <td style="padding: 15px;">
                                            <?php echo $patient['student_year']; ?>
                                        </td>
                                        <td style="padding: 15px;">
