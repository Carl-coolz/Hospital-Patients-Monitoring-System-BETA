...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Safely read optional student fields
    ...
    // Ensure the patients table has the new columns (adds them automatically if missing)
    ...
    $sql = "INSERT INTO patients (name, age, gender, condition_text, date_admitted, doctor_assigned, time_in, time_out, student_id, student_course) ";
    $sql .= "VALUES ('$name', $age, '$gender', '$condition', '$date_admitted', '$doctor', $time_in, $time_out, '$student_id', '$student_course')";
